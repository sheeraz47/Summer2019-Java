...
throws keyword: used for handling exceptions
        ...
        CALLER still has to deal with the exception, it's Caller' responsibility to handle the exception
...
Custom exception: we can create a class that extends exceptions to make it a 
